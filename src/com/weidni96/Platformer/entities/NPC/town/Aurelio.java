...
public class Aurelio extends NPC{
	 ...
	 * @param basis
	 */
	public Aurelio(int x, int y, Sprite sprite, Level level, boolean walker, String name, int actionChange, int basis) {
	...
	public void render(Screen screen){
		screen.renderNewHSB(x, y, sprite, true, 0.33f, 0.9f);
	}
}