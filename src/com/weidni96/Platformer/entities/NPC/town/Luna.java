...
public class Luna extends NPC{
	 ...
	 * @param basis
	 */
	public Luna(int x, int y, Sprite sprite, Level level, boolean walker, String name, int actionChange, int basis) {
	...
	public void render(Screen screen){
		screen.renderNewHSB(x, y, sprite, true, 0.95f, 0.9f);
		if(hairSprite != null){
			screen.renderNewHSB(x, y, hairSprite, true, 0.27f, 0.9f);
		}
	}
}