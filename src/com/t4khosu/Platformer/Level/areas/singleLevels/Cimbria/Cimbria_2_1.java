...
import com.t4khosu.Platformer.entities.NPC.town.*;
...
public class Cimbria_2_1 extends LoadLevel {
    ...
    public void initSurroundings() {
        interactiveEntities.add(new Chest(52 * 8, 13 * 8, Item.agroilberrySeed_ID, 8, true, this, Chest.ChestType.IRON));
        interactiveEntities.add(new Chest(17 * 8, 17 * 8, Item.agroilberrySeed_ID, 8, true, this, Chest.ChestType.IRON));
        interactiveEntities.add(new Sign(54 * 8, 46 * 8, "Block AG-01", Sign.SignType.ELECTRONICAL));
        interactiveEntities.add(new Sign(13 * 8, 3 * 8, "Block AG-02", Sign.SignType.ELECTRONICAL));
        interactiveEntities.add(new Sign(58 * 8, 37 * 8, "Block AG-01 WG-01", Sign.SignType.ELECTRONICAL));
        interactiveEntities.add(new Sign(58 * 8, 29 * 8, "Block AG-01 WG-02", Sign.SignType.ELECTRONICAL));
        interactiveEntities.add(new Sign(58 * 8, 21 * 8, "Block AG-01 WG-03", Sign.SignType.ELECTRONICAL));
        interactiveEntities.add(new Sign(19 * 8, 44 * 8, "Monument \"Inigo Narid\"", Sign.SignType.ELECTRONICAL));
        interactiveEntities.add(new Sign(22 * 8, 37 * 8, "Zane's Shop", Sign.SignType.ELECTRONICAL));
        interactiveEntities.add(new Sign(22 * 8, 30 * 8, "John's Shop+  (Viel besser als Zane's Laden)", Sign.SignType.ELECTRONICAL));
        interactiveEntities.add(new Sign(9 * 8, 37 * 8, "Wassily's Atelier", Sign.SignType.ELECTRONICAL));
