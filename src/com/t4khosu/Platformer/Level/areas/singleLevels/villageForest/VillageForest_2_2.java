...
import com.t4khosu.Platformer.entities.interactiveEntities.bookshelfes.Walker1_Bookshelf;
...
import com.t4khosu.Platformer.entities.enemies.slimes.UndergroundSlime;
...
public class VillageForest_2_2 extends LoadLevel {
	...
	protected void initSurroundings() {
		interactiveEntities.add(new Sign(37*8, 26*8, "Minenschachte G6", Sign.SignType.WOODEN));
