...
public class Iakob extends NPC {
	 ...
	 * @param basis
	 */
	public Iakob(int x, int y, Sprite sprite, Level level, boolean walker, String name, int actionChange, int basis) {
	...
	public void render(Screen screen){
		screen.renderNewHSB(x, y, sprite, true, 0.5f, 0.9f);
	}
}