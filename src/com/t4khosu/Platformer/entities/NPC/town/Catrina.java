...
public class Catrina extends NPC {
	 ...
	 * @param basis
	 */
	public Catrina(int x, int y, Sprite sprite, Level level, boolean walker, String name, int actionChange, int basis) {
	...
	public void render(Screen screen){
		screen.renderNewHSB(x, y, sprite, true, 0.5f, 0.6f);
		if(hairSprite != null){
			screen.renderNewHSB(x, y, hairSprite, true, 0.62f, 0.9f);
		}
	}
}
