...
public class Alexa extends NPC {
	 ...
	 * @param basis
	 */
	public Alexa(int x, int y, Sprite sprite, Level level, boolean walker, String name, int actionChange, int basis) {
	...
	public void render(Screen screen){
		screen.renderNewHSB(x, y, sprite, true, 0.56f, 0.9f);
		if(hairSprite != null){
			screen.renderNewHSB(x, y, hairSprite, true, 0.23f, 0.9f);
		}
	}
}